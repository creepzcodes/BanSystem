...
dependencies {
    implementation("com.zaxxer:HikariCP:6.3.0")          // <--- geändert!
    implementation("com.mysql:mysql-connector-j:9.3.0")  // <--- geändert!
...
tasks {
    ...
    named<ShadowJar>("shadowJar") {
        ...
        relocate("com.zaxxer.hikari", "dev.blockverse.libs.hikari") // <--- NEU
        relocate("com.mysql.cj", "dev.blockverse.libs.mysql")       // <--- NEU
